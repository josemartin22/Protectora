  ...
  <div class="centered">
    <v-card min-height="50%" width="40%">
      <div class="centered">
        ...
        <div>
          <v-text-field prepend-icon="mdi-email" label="Email" outlined v-model="email"></v-text-field>
          <v-text-field
          ...
          ></v-text-field>
          <div v-if="register">
            <v-text-field prepend-icon="mdi-rename-box" outlined label="Nombre" v-model="name"></v-text-field>
            <v-text-field
            ...
            <v-text-field
              ...
              v-model="address"
            ></v-text-field>
            <v-text-field prepend-icon="mdi-phone" outlined label="Teléfono" v-model="phone"></v-text-field>
          </div>
...
export default {
  ...
  methods: {
    submit() {
      ...
      else if (register && !protectora) this.registerUser();
    ...
    registerProtectora() {
      const { email, password, phone, address, name } = this;
      if (email && password && phone && address && name) {
        axios
          .post("/auth/register/protectora", {
            email,
            password,
            phone,
            address,
